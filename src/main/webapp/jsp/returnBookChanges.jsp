...
<body>
	...
	<div class="container">
		<h1>🔄 Return Book</h1>
		<form
			action="${pageContext.request.contextPath}/issuesAndReturns/returnRecord"
			method="post">

			<label>Select Member:</label> <input type="text" id="searchMember"
			...
			<c:choose>
				<c:when test="${step == 'book'}">
					<input type="submit" class="btn"
						formaction="${pageContext.request.contextPath}/issuesAndReturns/finalReturn"
						value="Return Book" />
				</c:when>
				<c:otherwise>
